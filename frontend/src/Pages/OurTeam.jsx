  ...
  return (
    <div className="font-sans text-white select-none min-h-screen" style={{ backgroundColor: '#140b29' }}>
      <div className="max-w-6xl mx-auto px-5">
        ...
        {/* Team Grid */}
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8 py-10 max-w-6xl">
          {members.map((member, index) => (
            ...
            >
              ...
              <p className="text-sm text-gray-300 leading-relaxed mb-2 transition-color duration-300 member-bio">
                {member.role}
              </p>
